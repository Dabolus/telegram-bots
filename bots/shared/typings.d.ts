...
declare module 'vosk' {
  ...
  /** Grammar The list of strings to be recognized */
  ...
  export class Recognizer<
    T extends XOR<
      ...
      Partial<GrammarRecognizerParam>
  ...
  > {
     ...
     *
     * @param {SpeakerModel} spk_model Speaker recognition model
     */
     ...
     *
     * @returns {string} the result in JSON format which contains decoded line, decoded
